    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex item-center justify-center text-teal-600 sm:justify-start">
              <img src="..\assets\logo2.png" alt="" className='w-20 h-auto ml-0' />
              <p className='font-semibold text-pink-500 text-lg mt-11'>Cosplay.In</p>
            </div>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-blue-500 transition hover:text-blue-700/75"
                >
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-gray-700">cosplayin@gmail.com</span>
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Cosplay.In</p>
          </div>
        </div>
      </div>
    </footer>
