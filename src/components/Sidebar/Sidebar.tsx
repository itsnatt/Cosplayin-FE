...
const Sidebar: React.FC<{ setCurrentView: (view: string) => void }> = ({ setCurrentView }) => {
  return (
    <div className="flex flex-col justify-between border-e bg-white h-full">
        ...
        <li>
          ...
          <li>
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary
                className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 no-underline"
              >
